...
- **Speech acts**:
  utterances that use a particular locution with a conventional meaning to achieve a social effect.
- **Conversational implicatures**:
  inferences tied to particular speech acts.
  These rely on:
  - general principles of rational, cooperative communication [@grice_logic_1975];
  - [literal meanings]{.gb-blue}.

...
According to Lewis, any given habit that persists within some community is a *convention* just in case the following hold:
...
4. The habit is optional or arbitrary, in the sense that it is selected from among some set of available alternative possible habits.
5. There is common knowledge within the community of the above criteria.
...
Here, Lewis is engaged in *conceptual analysis*:
...
That is, Lewis takes conditions 1 through 5 to *define* the term *convention*.
Why does he do this?
Well in part, because he thinks the criteria in 1 - 5 isolate and shed light on an interesting array of phenomena that exist among our species---driving on the right vs. left of the road (depending on where one lives), greeting people in a particular way, knocking on doors to request entry, and a zillion other things;
...
Does *convention*, when understood as abbreviating the conditions 1 through 5, have the same meaning as the ordinary English word *convention*?
Maybe, maybe not.
...
4. Whether or not teeth-brushing is optional or arbitrary may also seem tricky to determine.
...
5. Insofar as the above observations are accurate, they appear to be common knowledge.

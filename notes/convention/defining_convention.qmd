...
According to Lewis, any given habit or practice that persists within some community is a *convention* just in case the following conditions hold:

1. Everyone conforms, i.e., participates in the habit.
2. Everyone believes the other members of the community conform.
3. The other members of the community conforming provides a reason for conforming yourself.
4. People generally prefer for the other members of the community to conform, rather than not conform.
5. The habit is optional or arbitrary, in the sense that it is selected from among some set of available alternative possible habits (though once selected, it is fixed at the level of the community).
...
Lewis takes conditions 1 through 6 to *define* the term *convention*.
They all have to hold (they are necessary), and *only* they have to hold (they are sufficient), in order for something to count as a convention.

Why does he do this?
Well, in part, because he thinks the criteria in 1 - 6 isolate and shed light on an interesting array of phenomena that exist among our species---driving on the right vs. left of the road (depending on where one is driving), greeting people in a particular way, knocking on doors to request entry, and a zillion other things;
...
I'll go through the criteria here and try to see how well they apply to this particular practice.
...
2. With certain exceptions, people expect each other to conform;
   i.e., we generally expect others to have brushed their teeth.
3. It is perhaps a little bit tricky to determine whether others brushing their teeth provides a reason for one to brush one's own teeth.
   ...
   the more people engage in the practice, the more social pressure there is to conform.^[
	   In class, the subject of *frequency* of teeth-brushing came up.
	   It may be that brushing one's teeth, say, twice a day (as opposed to once, or four times), is largely motivated by the wish to conform to a widespread practice.
   ]
...
4. There appears to be a general preference that people brush their teeth.
   ...
   But also---insofar as standards of hygiene and cleanliness are arbitrary and culturally variable---maybe, people want to not have wasted their effort when they brush their *own* teeth.
...
5. Whether or not teeth-brushing is optional or arbitrary may also seem tricky to determine.
   ...
   on the other hand, it is a bit clearer what viable alternative practice might allow members of a community to adhere to a communal standard:
...
it's a convention when the community in which it is done adopts a standard (e.g., not having cavities, not being perceived as having bad breath)---one that teeth-brushing helps people meet.
...
- Truthfulness:
  try to never utter sentences of the language that are not true.^[
	  I.e., sentences that the language pairs up with sets of possible worlds which don't have the *actual* world as one of its elements.
  ]
- Trust:
...
As with other conventions, you can call someone out if they violate this convention.

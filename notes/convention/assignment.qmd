...
Due on Wednesday, September 2nd.

### Part 1

Pick one of the other practices that were brought up in class, and give an analysis of whether or not it meets criteria 1-5 outlined in [Defining convention](defining_convention.html).
...
Whatever practice you choose need not be well-known, and we need not generally be consciously aware of its existence.
It just needs to be something that people do within some community with which you're familiar.
...
Please consider and provide a response to the following: [is your analysis of the practice you've chosen consistent with your own intuitions about whether or not the practice is a convention?]{.underline}
...
This use of the word *damn*, which causes the frustration inference, appears, in some sense to *mean* that Jo is frustrated.
...
Explain why you think this, using the criteria for meaning$_{NN}$ that Grice discusses.
...
Do you think that the inference about Bo's "correct" use of English in these contexts, i.e., when he uses *were* in cases in which he might otherwise use *was*  is related to meaning$_{N}$ or meaning$_{NN}$?
...
In the sense relevant to natural meaning, or in the sense relevant to non-natural meaning?
Again, explain why, making reference to the criteria outlined by Grice.

...
(E.g., assume that *chair* is a noun that denotes a characteristic function of some subset of the relevant model's domain.)

### Part 2

Let's hypothesize, at least for the sake of this exercise that, *only* is a quantificational determiner;

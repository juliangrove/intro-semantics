...
Unclear, perhaps;
but one idea might be that understanding an event description involves, in some sense, constructing a mental representation of the event described, and it is easier for people to update mental representations of sequences of events with new events that are hypothesized to occur later in time than any events currently in the sequence than it is to for people to update them with new events that are hypothesized to occur earlier in time than some events currently in the sequence.
If this is true, and people know that it is true, then they might try to make their utterances easier to understand, given this fact.

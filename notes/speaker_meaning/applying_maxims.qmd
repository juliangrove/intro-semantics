...
One might reason about why this inference is produced as follows:
 ...
 - They opted not to make the [stronger]{.underline} statement that Jo did all of the readings.^[
   When I say that *Jo did all of the readings* is stronger than *Jo did some of the readings*, what I mean is that the first entails the second, but the second does not entail the first.
...
In case the inference made from this reasoning is merely that the speaker doesn't have enough evidence to say *all*, one would conclude that there is an intended *ignorance implicature*:
...
Here, we don't get the inference, say, that Bo doesn't want a matcha latte, or that Bo doesn't want a cappuccino, both of which would entail that he wants something with a lot of caffeine, and which are therefore stronger.

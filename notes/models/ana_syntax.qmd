...
$L_{ANA}$ has a few different kinds of expressions which are useful to distinguish.
First, it has *numerals*.
These are strings like $⌜1⌝$, $⌜2⌝$, $⌜57⌝$, and so on.
Second, it has *complex expressions*.
These are strings containing the symbols for the addition and multiplication operators, like $⌜(1 + 2)⌝$, $⌜((3 × 4) + 7)⌝$, and so on.
Finally, it has equations.
These are strings containing the "equals" symbol, like $⌜37 = (5 × 6)⌝$.

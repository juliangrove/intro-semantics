...
If it does, then we say that [$E_{2}$ is an inference of $E_{1}$ (or of an utterance of $E_{1}$)]{.underline}.

There are four kinds of inference that we'd like to be able to classify.
These are:
